...
/*
nysORM v1.0.0 - Object Relational Map
...
class ORM {
  ...
  */
  public function Qu($string, $json_content = true, $multiple_records = false, $params = false) {
    ...
    if ($this->driver == "sqlsrv") {
      ...
      if ($params) {
        $data = sqlsrv_query($this->con, $string, $params);
      } else {
  ...
  */
  public function Mod($string, $json_content = true, $params = false) {
